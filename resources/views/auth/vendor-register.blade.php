...
<head>
    ...
    <title>Gear 5 || Register as Vendor </title>
    <!-- plugins:css -->
                  ...
                  <div class="form-group">
                      ...
                      <div class="form-group">
                          <small class="text-center"></small>
                           <textarea class="form-control form-control-lg"  name="description" id="" cols="30" rows="10" placeholder="Goods/services Description" required></textarea>
                           <span class="invalid-feedback" role="alert">
                                <strong></strong>
                            </span>
                          </div>
